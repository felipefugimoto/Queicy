    ...
    methods: {
      ...
      calculateServiceValue(index) {
        ...
        if (selectedServiceData) {
          selectedService.value = selectedServiceData.preco; // Define o valor do serviço selecionado
        }
      },
      calculateTotal() {
        let total = 0;
      ...
      addService() {
        this.appointment.services.push({ servico_id: '', value: 0 }); // Adiciona um novo serviço vazio
      },
      removeService(index) {
